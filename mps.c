...
#define OUTPUT_INTERVAL      20                                        //何タイムステップごとにファイル出力するか

/* for three-dimensional simulation */                                 //三次元の場合
/*
#define DIM                  3
...
#define ARRAY_SIZE           5000                                       //粒子数上限
#define FINISH_TIME          2.0                                        //何秒間の現象を数値解析
#define KINEMATIC_VISCOSITY  (1.0E-6)                                   //粘性係数
#define FLUID_DENSITY        1000.0                                     //流体密度
#define G_X  0.0        
static double NumberDensity[ARRAY_SIZE];                                //粒子数密度
static int    BoundaryCondition[ARRAY_SIZE];                            //境界条件
